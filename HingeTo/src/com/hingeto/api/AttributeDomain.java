...
/**
 * <p>Java class for AttributeDomain.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AttributeDomain">
 *   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *     &lt;enumeration value="CommonTaxonomy"/>
...
public enum AttributeDomain {
    ...
    @XmlEnumValue("CommonTaxonomy")
    COMMON_TAXONOMY("CommonTaxonomy"),
    MPO("MPO");
    private final String value;

    AttributeDomain(String v) {
        value = v;
    }
    ...
    public static AttributeDomain fromValue(String v) {
        for (AttributeDomain c: AttributeDomain.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
