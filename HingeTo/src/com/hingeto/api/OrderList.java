 ...
 *       &lt;sequence>
 *         &lt;element name="SalesOrder" type="{https://www.hingeto.com/xml/V0.1}SalesOrderMessage" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OrderList {
     ...
     * {@link SalesOrderMessage }
     * 
     * 
     */
    public List<SalesOrderMessage> getSalesOrder() {
        if (salesOrder == null) {
            salesOrder = new ArrayList<SalesOrderMessage>();
        }
