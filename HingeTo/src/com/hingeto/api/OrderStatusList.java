 ...
 *       &lt;sequence>
 *         &lt;element name="OrderStatus" type="{https://www.hingeto.com/xml/V0.1}OrderStatusMessage" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OrderStatusList {
     ...
     * {@link OrderStatusMessage }
     * 
     * 
     */
    public List<OrderStatusMessage> getOrderStatus() {
        if (orderStatus == null) {
            orderStatus = new ArrayList<OrderStatusMessage>();
        }
